 ...
 */
package com.flurry.pageplugin.utils;
 ...
 *  <li><b>LeftPad/RightPad/Center/Duplicate</b>
 *      - pads a String</li>
 ...
 * Condition a {@code boolean} or {@code int} is being returned
...
public class StringUtils {
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>Duplicate a String {@code repeat} times to form a
     * new String.</p>
     *
     * <pre>
   ...
   //++++++++++++++++++++
	...
	public static int countIgnoreCase(String source, String sub) {
		...
		while (true) {
			int i = indexOfIgnoreCase(source, sub, j, source.length());
			if (i == -1) {
				break;
			}
			count++;
    ...
    /**
     * Count the tokens
     * @param str The String to be Tokenlized
     * @return
     */
    public static int countTokens(String str) {
        char c;
        int count = 0;
        int status = 0; // 0 for no token
        int i;
        for(i=0;i<str.length();i++)	{
            c = str.charAt(i);
            //if c is letter, a new word start or continued
    ...
    public final static String decimalFormat(String pattern, Object obj){
